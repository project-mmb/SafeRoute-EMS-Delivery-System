  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glow: "bg-card border-primary/30 shadow-glow hover:shadow-[0_0_60px_hsl(187_100%_50%_/_0.3)] hover:border-primary/50",
        emergency: "bg-card border-accent/50 shadow-emergency hover:shadow-[0_0_60px_hsl(270_70%_55%_/_0.4)]",
