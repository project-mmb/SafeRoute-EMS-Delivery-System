  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Accessing dispatch dashboard...",
      });
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <Card variant="glow" className="animate-scale-in">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl text-gradient-primary">Responder Login</CardTitle>
            <CardDescription>
              Access the drone dispatch dashboard
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="accessCode"
                    type="text"
                    placeholder="Enter responder access code"
                    value={accessCode}
            ...
            <div className="mt-6 p-4 bg-secondary/50 rounded-lg">
              <p className="text-xs text-muted-foreground text-center">
                ...
                This portal is for authorized emergency responders only. 
